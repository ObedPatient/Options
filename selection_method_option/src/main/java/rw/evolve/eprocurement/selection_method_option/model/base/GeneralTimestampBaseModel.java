 ...
 */
package rw.evolve.eprocurement.selection_method_option.model.base;
...
public class GeneralTimestampBaseModel {
    ...
    /** Timestamp when the Selection method option was created */
    @CreationTimestamp
    @Column(name = "created_at", length = 255, nullable = false, updatable = false)
    private LocalDateTime createdAt;

    /** Timestamp when the Selection method option was last updated */
    @UpdateTimestamp
    @Column(name = "updated_at", length = 255)
    private LocalDateTime updatedAt;

    /** Timestamp when the Selection method option was deleted */
