...
@Repository
public interface SelectionMethodOptionRepository extends JpaRepository<SelectionMethodOptionModel, Long> {
    /**
    ...
    /**
     * Retrieves a list of {SelectionMethodOptionModel} entities that have not been soft-deleted.
     * Only Selection method Options with a null {deletedAt} field are returned.
     *
