 ...
 */
package rw.evolve.eprocurement.schemes_option.model.base;
...
public class GeneralTimestampBaseModel {
    ...
    /** Timestamp when the Scheme option was created */
    @CreationTimestamp
    @Column(name = "created_at", length = 255, nullable = false, updatable = false)
    private LocalDateTime createdAt;

    /** Timestamp when the Scheme option was last updated */
    @UpdateTimestamp
    @Column(name = "updated_at", length = 255)
    private LocalDateTime updatedAt;

    /** Timestamp when the Scheme option was deleted */
