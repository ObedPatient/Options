 ...
 */
package rw.evolve.eprocurement.procurement_progress_status_option.model.base;
...
public class GeneralTimestampBaseModel {
    ...
    /** Timestamp when the Procurement progress option was created */
    @CreationTimestamp
    @Column(name = "created_at", length = 255, nullable = false, updatable = false)
    private LocalDateTime createdAt;

    /** Timestamp when the Procurement progress option was last updated */
    @UpdateTimestamp
    @Column(name = "updated_at", length = 255)
    private LocalDateTime updatedAt;

    /** Timestamp when the Procurement progress option was deleted */
