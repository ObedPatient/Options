 ...
 */
package rw.evolve.eprocurement.procurement_progress_status_option.utils;

import java.util.Random;

public class ProcurementProgressOptionIdGenerator {
    /**
     * Generates a unique identifier for a scheme option.
     * The ID         - is formatted as "PROCURE_PROGRESS_OPT_{timestamp}_{randomNumber}", where the timestamp     *
     * @return        - A unique procurement progress option ID as a String.
     */
    public static String generateId() {
        return String.format(
                "PROCURE_PROGRESS_OPT_%s_%s",
