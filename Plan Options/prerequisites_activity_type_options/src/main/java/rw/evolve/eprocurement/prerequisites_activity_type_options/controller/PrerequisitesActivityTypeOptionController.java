...
public class PrerequisitesActivityTypeOptionController {
    ...
    private final PrerequisitesActivityTypeOptionService prerequisitesActivityTypeOptionService;

    private final ModelMapper modelMapper;

    public PrerequisitesActivityTypeOptionController(
            PrerequisitesActivityTypeOptionService prerequisitesActivityTypeOptionService,
            ModelMapper modelMapper
    ){
        this.prerequisitesActivityTypeOptionService = prerequisitesActivityTypeOptionService;
