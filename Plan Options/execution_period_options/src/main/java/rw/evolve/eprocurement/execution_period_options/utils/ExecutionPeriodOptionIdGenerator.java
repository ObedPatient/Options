 ...
 */
package rw.evolve.eprocurement.execution_period_options.utils;

import java.util.Random;

public class ExecutionPeriodOptionIdGenerator {
    /**
     * Generates a unique identifier for a scheme option.
     * The ID         - is formatted as "EXECUTION_PERIOD_OPT_{timestamp}_{randomNumber}", where the timestamp     *
     * @return        - A unique scheme option ID as a String.
     */
    public static String generateId() {
        return String.format(
                "EXECUTION_PERIOD_OPT_%s_%s",
