 ...
 */
package rw.evolve.eprocurement.procurement_type_option.utils;

import java.util.Random;

public class ProcurementTypeOptionIdGenerator {
    ...
    public static String generateId() {
         ...
         * The ID         - is formatted as "PROCURE_TYPE_{timestamp}_{randomNumber}", where the timestamp     *
