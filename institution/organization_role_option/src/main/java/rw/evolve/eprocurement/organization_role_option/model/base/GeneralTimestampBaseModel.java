 ...
 */
package rw.evolve.eprocurement.organization_role_option.model.base;
...
public class GeneralTimestampBaseModel {
    ...
    /** Timestamp when the Organization Role option was created */
    @CreationTimestamp
    @Column(name = "created_at", length = 255, nullable = false, updatable = false)
    private LocalDateTime createdAt;

    /** Timestamp when the Organization Role option was last updated */
    @UpdateTimestamp
    @Column(name = "updated_at", length = 255)
    private LocalDateTime updatedAt;

    /** Timestamp when the Organization Role option was deleted */
