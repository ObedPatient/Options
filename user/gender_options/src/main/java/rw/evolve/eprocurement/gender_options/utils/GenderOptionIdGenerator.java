 ...
 */
package rw.evolve.eprocurement.gender_options.utils;

import java.util.Random;

public class GenderOptionIdGenerator {
    /**
     * Generates a unique identifier for a scheme option.
     * The ID         - is formatted as "GENDER_OPT_{timestamp}_{randomNumber}", where the timestamp     *
     * @return        - A unique gender option ID as a String.
     */
