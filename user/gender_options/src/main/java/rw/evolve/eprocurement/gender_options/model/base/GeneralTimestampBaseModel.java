 ...
 */
package rw.evolve.eprocurement.gender_options.model.base;
...
public class GeneralTimestampBaseModel {
    ...
    /** Timestamp when the Gender option was created */
    @CreationTimestamp
    @Column(name = "created_at", length = 255, nullable = false, updatable = false)
    private LocalDateTime createdAt;

    /** Timestamp when the Gender option was last updated */
    @UpdateTimestamp
    @Column(name = "updated_at", length = 255)
    private LocalDateTime updatedAt;

    /** Timestamp when the Gender option was deleted */
